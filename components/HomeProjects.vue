    ...
    <div class="container-narrow">
      ...
      <div class="home-projects-main">
        <div class="hp-narrow hp-row">
          <div class="hp-col-50">
            <img
              :src="homeData.data.slices[2].primary.project_one_image.url"
              alt=""
            />
          </div>
        ...
        <div class="hp-narrow hp-row">
          <div class="hp-col-50 text-right">
            <div class="hp-content">
              <div class="hp-title">
                <h2>
                  {{ homeData.data.slices[2].primary.project_three_title }}
                </h2>
              </div>
              <div class="hp-desc">
                <p>
                  {{ homeData.data.slices[2].primary.project_three_content }}
                </p>
              </div>
              <div class="hp-logos"></div>
            </div>
          ...
          <div class="hp-col-50">
            <img
              :src="homeData.data.slices[2].primary.project_three_image.url"
              alt=""
            />
          </div>
        </div>
        ...
        <div class="hp-wide hp-row">
          ...
          <div class="hp-col-40">
            <div class="hp-content">
              <div class="hp-title">
                <h2>
                  {{ homeData.data.slices[2].primary.project_four_title }}
                </h2>
              </div>
              <div class="hp-desc">
                <p>
                  {{ homeData.data.slices[2].primary.project_four_content }}
                </p>
              </div>
              <div class="hp-logos"></div>
            </div>
...
<style src="./HomeProjects.scss" scoped></style>
